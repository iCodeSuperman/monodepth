...
parser.add_argument('--platform',                  type=str,   help='which platform', default='modelarts')
parser.add_argument('--result',                    type=str,   help="the result directory where the model checkpoints will be written.", default="result")
parser.add_argument('--obs_dir',                   type=str,   help="obs result path, not need on gpu and apulis platform.", default="obs://cann-id2099/")
parser.add_argument('--num_npus',                  type=int,   help='number of NPUs to use for training', default=1)
