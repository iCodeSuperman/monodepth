...
if [ x"${modelarts_flag}" != x ];
then
  python3.7 ./monodepth_main.py --mode train --model_name my_model --filenames_file /home/ma-user/modelarts/user-job-dir/code/utils/filenames/kitti_train_files.txt --data_path ${data_path} --log_directory ${output_path}
  python3.7 ./monodepth_main.py --mode test --data_path ${data_path} --filenames_file /home/ma-user/modelarts/user-job-dir/code/utils/filenames/kitti_stereo_2015_test_files.txt --log_directory ${output_path} --checkpoint_path /home/ma-user/modelarts/user-job-dir/code/my_model/model-181250
  python3.7 ./utils/evaluate_kitti.py --split kitti --predicted_disp_path /home/ma-user/modelarts/user-job-dir/code/my_model/disparities.npy --gt_path ${data_path}

else
    echo "==================== BBBBB ===================="
    # python3.7 ./monodepth_main.py --mode train --model_name my_model --filenames_file /home/ma-user/modelarts/user-job-dir/code/utils/filenames/kitti_train_files2.txt --data_path=${data_path} --log_directory ${output_path} 1>${print_log} 2>&1
    python3.7 ./monodepth_main.py --mode test --data_path ${data_path} --filenames_file /home/ma-user/modelarts/user-job-dir/code/utils/filenames/kitti_stereo_2015_test_files.txt --log_directory ${output_path} --checkpoint_path /home/ma-user/modelarts/user-job-dir/code/my_model/model-12500
fi
